                    ...
                    <form method="post" action="savestudentedit.jsp" name="form1">
                        <table border=0 cellpadding=3 cellspacing=0 width =81% align=center>
                            ...
                            <tr bgcolor =#FEF7E9>
                                ...
                                <td bgcolor="#F3E8DA"><input TYPE="text" NAME="college" size=30 maxlength=30 value='<%=s2%>' placeholder="College">                       </td>
                            </tr>
                            <tr bgcolor =#FEF7E9>
                                <td bgcolor="#F3E8DA">
                                    <strong><font SIZE="3" COLOR="#666600" face ='Times New Roman, Times, serif'>College Phone</font> </strong>
                                </td>
                                <td bgcolor="#F3E8DA"><input TYPE="text" NAME="collegephone" size=30 maxlength=30 value='<%=s3%>'><font SIZE="2" COLOR="#CC0000" face =arial (STD-No.) placeholder="College Phone">                                 </td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                                <td>
